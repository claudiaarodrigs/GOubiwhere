...
To allow the coexistence between the database continuous fill, and, at the same time, its interaction, it was created two separated apps: DataCollector.exe and Interface.exe. 
